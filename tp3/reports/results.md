...
|----------------------|-------|---------------|-----------|---------|----------|
| `sgd_lr_low`  | 0.001 | 100           | 92.1%     | 89.6%   | 76.5%    |
| `baseline`    | 0.01  | 50            | 96.3%     | 93.9%   | 83.9%    |
| `sgd_lr_high` | 0.1   | 92 ✓          | 99.3%     | 95.9%   | **86.1%** |
...
|--------------------|-----------|---------------|-----------|----------|
| `baseline`  | SGD       | 50            | 96.3%     | 83.9%    |
| `momentum`  | Momentum  | 63 ✓          | 99.3%     | 85.9%    |
| `adam`      | Adam      | 50            | 99.5%     | 85.4%    |
...
|---------------------|-----------------|------------|---------------|----------|
| `arch_small` | [784, 32, 10]   | ~25k       | 40 ✓          | 84.4%    |
| `adam`       | [784, 64, 10]   | ~50k       | 50            | 85.4%    |
| `arch_large` | [784, 128, 10]  | ~101k      | 40 ✓          | **85.9%** |
| `arch_deep`  | [784, 64, 32, 10]| ~52k      | 34 ✓          | 85.7%    |
...
|---------------------|------------------|-----------|----------|
| `baseline`   | MSE + tanh       | SGD       | 83.9%    |
| `adam`       | MSE + tanh       | Adam      | 85.4%    |
| `softmax`    | CE + softmax     | Adam      | 85.8%    |
...
**`sgd_lr_high`**: SGD lr=0.1, [784, 64, 10], early stop epoch 92 → **86.1% accuracy en test**.
...
|------------------------------------|--------------------------|------------------|---------------|----------|
| `softmax` (original)   | more_digits (15.7k)      | [784,128,64,10]  | 25 ✓          | 95.3%    |
| — tuned arch                       | more_digits (15.7k)      | [784,300,10]     | 41 ✓          | 95.6%    |
| — tuned deep                       | more_digits (15.7k)      | [784,128,64,10]  | 39 ✓          | 95.6%    |
| `softmax` (final)      | more_digits + digits (28k) | [784,256,10]  | ~36 ✓         | **96.4%** |
