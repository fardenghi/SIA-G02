...
Ver [`src/ej1/README.md`](src/ej1/README.md) para documentación completa: fases, hallazgos, decisiones de diseño y guía de replicación.

```bash
make run-ej1     # ejecuta las 7 fases en orden
make clean-ej1   # elimina outputs generados
```
