...
Ejecuta el AG múltiples veces por cada método de selección, agrega los
resultados con promedio ± desviación estándar y genera gráficos comparativos
robustos.
"""
...
def run_method(
    ...
    with ProcessPoolExecutor(max_workers=num_runs) as executor:
        futures = {
            executor.submit(
                run_once, selection_method, target_image, evo_config,
